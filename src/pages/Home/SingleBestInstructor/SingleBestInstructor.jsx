...
AOS.init();
const SingleBestInstructor = ({instructor}) => {
    return (
        
              <div data-aos="fade-up" data-aos-offset="200" data-aos-easing="ease-in-sine" data-aos-duration="600" className="max-w-sm bg-white shadow-lg rounded-lg overflow-hidden my-4">
...
export default SingleBestInstructor;